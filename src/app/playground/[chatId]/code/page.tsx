...
import CodeSessionClient from '~/app/playground/_components/CodeSessionClient'
  ...
  return (
    <HydrateClient>
      <main className="p-6 max-w-4xl mx-auto">
        <h1 className="text-2xl font-semibold mb-4">Code Session</h1>
        <CodeSessionClient chatId={chatId} />
      </main>
    </HydrateClient>
  )
}
